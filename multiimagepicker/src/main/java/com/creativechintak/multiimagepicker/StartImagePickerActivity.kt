...
class StartImagePickerActivity : AppCompatActivity() {
    ...
    private fun initParams() {
        maxSelectionLimit = intent.getIntExtra(Constants.BUNDLE_MAX_SELECTION_LIMIT,
            MAX_PICTURE_LIMIT)
    ...
    private fun checkForGalleryPermission(hasAskedOnce: Boolean = false) {
        val result = PermissionUtils.checkAndRequestPermissions(this, PERMISSIONS_GALLERY_WITH_WRITE.toMutableList(),
